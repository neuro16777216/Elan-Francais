...
import { Send, User, Bot, Loader2, Mic, MicOff, Volume2, Play } from 'lucide-react';
      ...
      <div className="p-4 bg-white border-t border-black/5">
        ...
        <div className="flex gap-2">
          <button
            ...
            title={retryCount > 0 ? `Tentative de reconnexion ${retryCount}/3...` : "Entrée vocale"}
          >
